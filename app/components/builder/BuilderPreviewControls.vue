<template>
  <div class="flex flex-col px-1 bg-zaux-white border-b-slim border-zaux-light-grey">
    <div class="flex shrink-0 flex-wrap justify-between items-top gap-x-3 gap-y-1 max-[1200px]:px-1 pb-1">
