<template>
  <div class="zb-app flex h-dvh flex-col overflow-hidden bg-zaux-light font-builder text-[13px] text-zaux-dark max-[900px]:h-auto max-[900px]:min-h-dvh max-[900px]:overflow-auto" :class="{ 'zb-app--preview': previewOnly }">
    <BuilderHeader />
...
export default defineComponent({
  components: { BuilderButton, BuilderSidebar, BuilderCanvas, BuilderInspector, BuilderDialog, BuilderStyles, BuilderResizeHandle, BuilderHeader },
  setup() {
    ...
    return { ...builder, leftWidth, rightWidth, resizePanel, downloadRecovery: () => downloadText('zaux-recovery.json', builder.recovery.value ?? '') };
  }
});
</script>
