<template>
	<div
		ref="host"
		class="min-w-0 overflow-hidden rounded-xxs border-slim border-zaux-light-grey focus-within:outline focus-within:outline-2 focus-within:outline-zaux-accent"
	/>
</template>
<script>
