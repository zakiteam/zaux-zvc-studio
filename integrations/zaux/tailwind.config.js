...
export default {
  ...source,
  theme: { ...source.theme, extend: { ...source.theme.extend, fontFamily: { ...source.theme.extend?.fontFamily, builder: ['Inter', 'system-ui', 'sans-serif'] }, minHeight: { 0: '0px' }, spacing: { '2.5': '1.25rem' } } },
